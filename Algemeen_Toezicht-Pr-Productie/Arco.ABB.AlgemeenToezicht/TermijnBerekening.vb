...
Public Class TermijnBerekening
    ...
    Private Sub SetTermijn_handelingen(ByVal WFCurrentCase As cCase)
        ...
        If StapNummer <= 2 And AardDossier = "klacht" Then
            ...
            Arco.Utils.Logging.Log("termijn tot opvraging " & HuidigeTermijn, "d:\arco\logging\algemeentoezicht.log")

        Else
            GeenDeadline(WFCurrentCase)
            HuidigeTermijn = ""
            Arco.Utils.Logging.Log("termijn na  opvraging zou moeten leeg zijn " & HuidigeTermijn, "d:\arco\logging\algemeentoezicht.log")
                                    ...
                                    If StapNummer >= 3 And StapNummer <= 9 Then
                                        ...
                                        If Not String.IsNullOrEmpty(DatumOntvangstStukken) Then
                                            ...
                                            If lsTermijn > 0 Then
                                                ...
                                                HuidigeTermijn = AddDays(DatumOntvangstStukken, 153)
                                                Arco.Utils.Logging.Log("Dossier komt hier en termijn is = " & HuidigeTermijn, "d:\arco\logging\algemeentoezicht.log")
