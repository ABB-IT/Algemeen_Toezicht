...
Public MustInherit Class AlgemeenToezichtBrief
    ...
    Public Overrides Function ReplaceTags(ByVal lsContent As String, ByVal voCase As Doma.Library.Routing.cCase) As String
        ...
        Dim iBestuurlocatie As Integer = voCase.GetProperty(Of Integer)("bestuur_lokatie")
        '        Try
        'If lsbestuur <> "" Then
        'Dim loBestuur As Bestuur = Bestuur.GetBestuur(lsbestuur)
        'iBestuurlocatie = loBestuur.BESTUUR_LOKATIE
        Arco.Utils.Logging.Log("Binnen AT de waarde van locatiecode = " & iBestuurlocatie, "d:\arco\logging\algemeentoezicht.log")
        'End If
        ...
        Dim loAfdeling As Afdeling = Afdeling.GetAfdeling_AT(loBehandelaar.AfdelingNaam, iBestuurlocatie)
